					...
					<li>
						<div class="panel">
							...
							<div class="button">
								<a class="link"
									attrcheck="7bffd7f8-6bbd-4c44-aef9-79b85ff8e5c5"
									rel="/comingDocument/simpleSearchDocuments.html"> <img
					...
					<li>
						<div class="panel">
							...
							<div class="button">
								<a class="link"
									attrcheck="7bffd7f8-6bbd-4c44-aef9-79b85ff8e5c5"
									rel="/comingDocument/complexSearchDocuments.html"> <img
					...
					<li>
						<div class="panel">
							...
							<div class="button">
								<a class="link"
									attrcheck="111ad63e-d353-4c17-8a82-73fd5ac889b8"
									rel="/user/listUsers.html">
									<img src="/images/user_management.png" alt="">Quản lý người dùng
								</a>
							</div>
							<div class="button">
								<a class="link"
									attrcheck="111ad63e-d353-4c17-8a82-73fd5ac889b8"
									rel="/department/listDepartments.html"> 
									<img src="/images/department.png" alt="">Quản lý phòng ban
								</a>
							</div>
							<div class="button">
								<a class="link"
									attrcheck="111ad63e-d353-4c17-8a82-73fd5ac889b8" rel="/documentType/listDocumentTypes.html">
									<img src="/images/document_type.png" alt="">Quản lý loại tài liệu
								</a>
							</div>
						</div>
					</li>
