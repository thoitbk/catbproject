...
<div id="Ribbon" class="officebar">
	<ul>
						...
						<div class="panel">
							...
							<div class="button">
								<a class="link"
									...
									rel="/document/unreadDocuments.html"> 
									<img src="/images/unread-document.png" alt="">Văn bản đến chưa đọc
								</a>
							</div>
							<div class="button">
								<a class="link"
									attrcheck="7bffd7f8-6bbd-4c44-aef9-79b85ff8e5c5"
									rel="/document/simpleSearchInboundDocuments.html"> 
									<img src="/images/in_document.png" alt="">Văn bản đến
								</a>
							</div>
							<div class="button">
								<a class="link"
									attrcheck="0e44b561-a615-4cd4-a0ef-9e2f0bc56ec6"
									rel="/document/simpleSearchOutboundDocuments.html"> 
									<img src="/images/out_document.png" alt="">Văn Bản đi
								</a>
							</div>
						</div>
					</li>
		...
		<a class="link" rel="#">Văn bản đến</a>
					...
					<li>
						<div class="panel">
							...
							<div class="button">
								<a class="link"
									attrcheck="7bffd7f8-6bbd-4c44-aef9-79b85ff8e5c5"
									rel="/document/simpleSearchInboundDocuments.html"> <img
									src="/images/simple_search.png" alt="">Tìm kiếm đơn
									giản
								</a>
							</div>
						</div>
					...
					<li>
						<div class="panel">
							...
							<div class="button">
								<a class="link"
									attrcheck="7bffd7f8-6bbd-4c44-aef9-79b85ff8e5c5"
									rel="/document/complexSearchInboundDocuments.html"> <img
									src="/images/complex_search.png" alt="">Tìm kiếm nâng cao
								</a>
							</div>
						</div>
					</li>
		...
		<li attrcheck="0e44b561-a615-4cd4-a0ef-9e2f0bc56ec6">
		<a class="link" rel="#">Văn bản đi</a>
			<div style="display: none;" class="officetab">
				<ul>
					<li>
						<div class="panel">
							...
							<div class="button">
								<a class="link"
									attrcheck="0e44b561-a615-4cd4-a0ef-9e2f0bc56ec6"
									rel="/document/simpleSearchOutboundDocuments.html"> <img
									src="/images/simple_search_out.png" alt="">Tìm kiếm đơn
									giản
								</a>
							</div>
						</div>
					...
					<li>
						<div class="panel">
							...
							<div class="button">
								<a class="link"
									attrcheck="0e44b561-a615-4cd4-a0ef-9e2f0bc56ec6"
									rel="/document/complexSearchOutboundDocuments.html"> <img
									src="/images/complex_search_out.png" alt="">Tìm kiếm nâng cao
								</a>
							</div>
						</div>
					</li>
