...
function report() {
	...
	var url = '/document/reportOutbound.html?smonth=' + month + '&syear=' + year;
...
<div class="box960">
	...
	<div class="content_960">
		<form action="/document/simpleSearchOutboundDocuments.html" method="GET">
...
<div class="khung_content_960" id="gridCongViec">
	...
	<div class="content-grid">
		...
		<div class="bottom-pager">
			<div class="left">
				<div class="pages">
					<t:paging pageInfo="${pageInfo}" link="/document/simpleSearchOutboundDocuments.html" params="${params}"/>
				</div>
			</div>
			<div class="right">
