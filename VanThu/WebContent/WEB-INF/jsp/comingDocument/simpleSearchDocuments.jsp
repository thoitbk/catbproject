...
function report() {
	...
	var url = '/comingDocument/report.html?smonth=' + month + '&syear=' + year;
...
<div class="box960">
	...
	<div class="content_960">
		<form action="/comingDocument/simpleSearchDocuments.html" method="GET">
...
<div class="khung_content_960" id="gridCongViec">
	...
	<div class="content-grid">
		...
		<div class="bottom-pager">
			<div class="left">
				<div class="pages">
					<t:paging pageInfo="${pageInfo}" link="/comingDocument/simpleSearchDocuments.html" params="${params}"/>
				</div>
			</div>
			<div class="right">
