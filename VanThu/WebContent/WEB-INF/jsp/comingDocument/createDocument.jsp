...
$(function() {
	...
	$("#createComingDocumentViewModel").submit(function(event) {
		...
		$.post($(this).attr("action"), { 
		  ...
		  .done(function( data ) {
			  ...
			  if (data.code == 0) {
				  ...
				  window.location.href="/comingDocument/createDocument.html";
			  }
		  });
	});
});
...
<div class="box960">
	...
	<div class="content_960">
		<form action="/comingDocument/createDocument.html" method="get" id="createComingDocumentViewModel">
			...
			<table class="table-form" style="width: 80%;" align="center">
				<tr>
					...
					<td class="data txtinput"><input type="text" name="sign" id="sign" /></td>
				</tr>
				<tr>
