...
public class ComplexSearchComingDocumentsVO {
	...
	public ComplexSearchComingDocumentsVO() {
		
	}

	public ComplexSearchComingDocumentsVO(String sign, Integer type,
			Integer confidentialLevel, Integer urgentLevel, Integer sender,
			Date fromPublishDate, Date toPublishDate, Date fromReceiveDate,
			Date toReceiveDate, String abs) {
		this.sign = sign;
		this.type = type;
