...
public class ComplexSearchOutboundDocumentsViewModel {
	...
	public ComplexSearchOutboundDocumentsViewModel() {
		
	}

	public ComplexSearchOutboundDocumentsViewModel(String ssign, Integer stype,
			Integer sconfidentialLevel, Integer surgentLevel,
