...
public class ComplexSearchDocumentsVO {
	...
	public ComplexSearchDocumentsVO() {
		
	}

	public ComplexSearchDocumentsVO(String sign, Integer type,
			Integer confidentialLevel, Integer urgentLevel, Integer sender,
			Integer receiver, String signer, Date fromPublishDate,
			Date toPublishDate, Date fromSendDate, Date toSendDate, String abs) {
		this.sign = sign;
		this.type = type;
